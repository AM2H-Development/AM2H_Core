...
// Pin Setup
uint8_t constexpr CORE_SCL{0}; // I2C SCL must be "0" for ESP8266
uint8_t constexpr CORE_SDA{2};  // I2C SDA must be "2" for ESP8266

uint8_t constexpr CORE_ISR_PIN{1}; // Interrupt
uint32_t constexpr CORE_ISR_DEBOUNCE{50}; // debounce time in ms

uint8_t constexpr CORE_TX{1}; // Serial TX only active when SERIALDEBUG is enabled
uint8_t constexpr CORE_RX{3};  // Serial RX only active when SERIALDEBUG is enabled

uint8_t constexpr CORE_STATUS_LED{2}; // Internal LED (blue)
uint8_t constexpr CORE_DQ{3};  // Onewire
...
// I2C config
uint8_t constexpr TCAADDR{0x70}; // Multiplexer address

// Connection Status
uint8_t constexpr DEV_RESTART_PENDING   {0x00};
uint8_t constexpr CONN_UNKNOWN          {0x01};
uint8_t constexpr WLAN_AP_PROV          {0x02};
uint8_t constexpr WLAN_CONNECTED        {0x03};
uint8_t constexpr MQTT_CLIENT_CONNECTED {0x04};
uint8_t constexpr DEV_CONFIGURED        {0x05};

// API Updates
uint8_t constexpr NO_UPDATE_REQUIRED        {0b00000001};
uint8_t constexpr COMMIT_TO_EEPROM_REQUIRED {0b00000010};
uint8_t constexpr WLAN_RESET_REQUIRED       {0b00000100};
uint8_t constexpr MQTT_RESET_REQUIRED       {0b00001000};
uint8_t constexpr MQTT_UPDATE_REQUIRED      {0b00010000};
// #define MQTT_PUBLISH_MESSAGE      0b00100000
uint8_t constexpr ESP_RESET_REQUIRED        {0b10000000};
...
uint8_t constexpr MQTT_SERVER_LEN {64};
uint8_t constexpr DEVICE_ID_LEN {16};
uint8_t constexpr NS_LEN {8};
uint8_t constexpr SSID_LEN {32};
uint8_t constexpr PW_LEN {32};
uint8_t constexpr SERVICE_LEN {8};
uint8_t constexpr LOC_LEN {32};
